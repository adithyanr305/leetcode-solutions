class Solution:
    def earliestFinishTime(self,landStartTime: List[int], landDuration: List[int],waterStartTime: List[int],waterDuration: List[int]) -> int:
        ...
        water_land =  min(max(s, min_water_end) + d for s, d in zip(landStartTime, landDuration))
        land_water =  min(max(s, min_land_end) + d for s, d in zip(waterStartTime, waterDuration))
